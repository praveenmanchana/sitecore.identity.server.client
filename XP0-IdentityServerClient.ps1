Param(
	...
	$SCInstallRoot = "C:\temp\sitecore\9.3\working",
	$PackagesTempLocation = "C:\temp\sitecore\9.3\downloadforcompare",
	# Root folder to install the site to. If left on the default [systemdrive]:\\inetpub\\wwwroot will be used
	$SitePhysicalRoot = "",
	# The Sitecore site CD instance name.
    $SitecoreCDSiteName = "$prefix.cd.dev.local",
	# Identity Server site name
	$IdentityServerSiteName = "$prefix.identityserver.client.dev.local",
	# The Path to the license file
	$LicenseFile = "C:\temp\sitecore\license.xml",
	# The DNS name or IP of the SQL Instance.
	$SqlServer = "(local)",
	# A SQL user with sysadmin privileges.
	$SqlAdminUser = "sa",
	# The password for $SQLAdminUser.
	$SqlAdminPassword = "Password01",
	...
	$PasswordRecoveryUrl = "https://$SitecoreCDSiteName",
	...
	$AllowedCorsOrigins = "https://$SitecoreCDSiteName",
	# Security script path
	$SecurityUserScriptPath = "$PSScriptRoot\\CreateUser.ClientSecurity.sql"
)

# Install XP0 via combined partials file.
$singleDeveloperParams = @{
    Path = "$PSScriptRoot\\XP0-IdentityServerClient.json"
    SqlServer = $SqlServer
	...
	SitecoreCDSiteName = $SitecoreCDSiteName
    PasswordRecoveryUrl = $PasswordRecoveryUrl
    SitecoreIdentityAuthority = $SitecoreIdentityAuthority
    ClientSecret = $ClientSecret
    AllowedCorsOrigins = $AllowedCorsOrigins
    SitePhysicalRoot = $SitePhysicalRoot
	PackagesTempLocation = $PackagesTempLocation
	SecurityUserScriptPath = $SecurityUserScriptPath
}

Push-Location $PSScriptRoot

Install-SitecoreConfiguration @singleDeveloperParams *>&1 -Verbose | Tee-Object XP0-IdentityServerClient.log
